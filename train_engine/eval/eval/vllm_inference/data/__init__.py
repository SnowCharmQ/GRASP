...
# from train.data_utils import temporal_video_grounding_templates
...
#     def __init__(
#         self,
#         processor: TimeViperVLProcessor,
#         dataset_name: str,
...
#         # self.prompt = prompt if prompt is not None else DEFAULT_MCQ_PROMPTS[prompt_type]
